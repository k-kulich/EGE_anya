...
Короче теперь ДЗ для удобства будут на КЕГЭ. Начнем с вот такого списка:

ДЗ по теоретическим номерам: `25169703`.

ДЗ по 3 заданию: `25159675`.

ДЗ по 17 заданию: `25159669`.

ТЕПЕРЬ повторение всего остального питонячьего: `25169707`.

Все задания (по типам) повторяются по нескольку раз в зависимости от ДЗ. Тут его много сразу, так что решай по мере возможности.

---

## ДЗ 6

Итак, ДЗ по разным номерам (сразу скидываю несколько, решишь, с чего начать): `25174568`, `25177821`, `25177822`, `25177823`, `25177825`.

Также вариант примерно той же сложности, что я сделала для пробника 12.04: `25177828`.

---

## ДЗ 7

ДЗ по оставшимся темам: `25194226`, `25194227`, `25194228`, `25194229`, `25194230`, `25194231`, `25194232`.

А еще докидываю полуварианты (задания 1-24):
...
`25203055` - 25-27 номера
`25203056` - вариант рандом

## Доп раздел - варианты!


Чтобы было _много_ практики, тут еще есть несколько вариантов по уровням сложности:

Полувариант 1: `25154180` (из ДЗ 3).

Полувариант 2: `25154601` (посложнее).

Полувариант 3: `25154606` (гроб, если есть желание себя испытать).

Полувариант 4: `25159680`. В него влючены все задания Excel, а также 17 номер.

__Желательно__ зарегаться и проходить под своим профилем ИЛИ запоминать непонятные номера, чтобы я могла что-то подсказать потом.
